...
Before playing the example scene, inspect ExampleManagerPackage. In the 
Inspector view, click on "Assign managers". Then you can play the example 
scene in this folder.
